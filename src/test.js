...
(function() {
  ...
  $(document).ready(function() {
    ...
    myCallbackFn = function() {
      ...
      return console.log(phistory.getHistory());
    };
    phistory.loadHistory(myCallbackFn);
    return null;
  });
  ...
  window.hv.Bookmarks = function() {
    var bookMarks, bookmarkIt, createBookmark, hideInactiveTasks, renderTaskMenu, storedBookmarks, storedContexts, toggleActiveState;
