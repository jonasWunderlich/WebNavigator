...
(function() {
  var addClearDiv, addDevInfo, block, blockStyle, blockSum, blocks, bmarks, bookMarks, bookmarkIt, createBlocks, createBookmark, createButtons, createHistory, filter, hideInactiveTasks, idToRef, initSlider, lastUrl, lastVid, loadBookmarks, loadHistory, logInfo, max, min, phistory, processHistoryItems, processVisitItems, processed, reload, renderItem, renderTaskMenu, siteHistory, specialise, start, storedBookmarks, storedContexts, tabArray, tabconnections, toggleActiveState, v_max, visitIdAufSID;
