...
(function() {
  var addClearDiv, addDevInfo, blockSum, block_counter, block_set, blocks, bookMarks, bookmarkIt, createBlocks, createBookmark, createButtons, createHistory, filter, googlevisible, hideInactiveTasks, idToRef, initSlider, lastUrl, lastVid, loadBookmarks, loadHistory, logInfo, max, min, processHistoryItems, processVisitItems, processed, reload, renderItem, renderTaskMenu, shortenTitle, siteHistory, specialise, start, storedBookmarks, storedContexts, tabArray, tabconnections, thelastTitle, thelastURL, toggleActiveState, urltoblock, v_max, visitIdAufSID;
