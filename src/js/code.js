...
(function() {
  var addClearDiv, addDevInfo, block, blockId, blockStyle, blockSum, blocks, bmarks, bookMarks, bookmarkIt, createBlocks, createBookmark, createButtons, filter, hideInactiveTasks, idToRef, idToVid, initSlider, lastUrl, lastVid, loadBookmarks, loadHistory, logInfo, phistory, processHistoryItems, processVisitItems, processed, reload, renderItem, renderTaskMenu, siteHistory, specialise, storedBookmarks, storedContexts, tabArray, tabconnections, toggleActiveState, v_max, visitIdAufSID;
  ...
  $(document).ready(function() {
    var createBlocks, createHistory;
    ...
    createBlocks = function() {
      var blockdings, contextGroup, item, key, num, _results;
      ...
      for (key in siteHistory) {
        ...
        if (item.context !== "" && !$(".group" + item.block).hasClass(item.context)) {
